...
namespace DatabaseTesting.Watchdog
{
    public static class WatchdogExtensions
    {
        ...
        public static void StartAsActiveUser(this Process process)
        {
            ...
            if (!AdvApi32.DuplicateTokenEx(userTokenPtr,
                AdvApi32.MAXIMUM_ALLOWED,
                null,
                SECURITY_IMPERSONATION_LEVEL.SecurityIdentification,
                TOKEN_TYPE.TokenPrimary,
                out duplicateUserTokenPtr))
            {
                throw new Win32Exception(Marshal.GetLastWin32Error());
            }
            ...
            const CREATE_PROCESS_FLAGS processFlags = CREATE_PROCESS_FLAGS.NORMAL_PRIORITY_CLASS | 
            ...
            if (!AdvApi32.CreateProcessAsUser(duplicateUserTokenPtr,
